...
describe('InventoryForm', () => {
  ...
  beforeEach(() => {
    mockFormData = { name: '', type: 'plant', quantity: 0, quantityType: '', isImportant: false, desiredQuantity: 0 };
    mockOnCancel = vi.fn();
    mockOnSubmit = vi.fn();
  });

  const renderForm = (errors = {}) => 
    render(InventoryForm, { props: { formData: mockFormData, errors, onCancel: mockOnCancel, onSubmit: mockOnSubmit } });
