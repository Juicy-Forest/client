...
describe('TaskSection', () => {
  ...
  const mockTasks = [
    { _id: '1', name: 'Task 1', description: 'Description 1', isComplete: false },
    { _id: '2', name: 'Task 2', description: 'Description 2', isComplete: true }
  ];
  ...
  it('deletes task when confirmed', async () => {
    ...
    expect(mockFetch).toHaveBeenCalledWith('http://localhost:3030/tasks/1',
